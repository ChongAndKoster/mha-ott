...
def assign_tasks(username, condition, start_date, study_id, n8m95):
	...
	if start_date == "":
		...
		# get start date 2023-10-31
		date_started = datetime.datetime.strptime(start_date, '%Y-%m-%d')		
	...
	# create user
	user = UserDetails(username=username, date_started=date_started, week_1_start=week_1_start, week_1_expire=week_1_expire, week_2_start=week_2_start, week_2_expire=week_2_expire, week_3_start=week_3_start, week_3_expire=week_3_expire, week_4_start=week_4_start, week_4_expire=week_4_expire, condition=condition, study_id=study_id, n8m95=n8m95)
	user.save()
